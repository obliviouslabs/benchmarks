...
| :--- |  :---: | :---: | :---: | :---: |
| $2^{10}$ | 7.65 | 2.00 | 3.44 | **1.51** |
| $2^{11}$ | 8.81 | 2.25 | 2.18 | **2.11** |
| $2^{12}$ | 10.57 | 2.56 | 2.36 | **2.53** |
| $2^{13}$ | 12.96 | 4.10 | 2.76 | **2.62** |
| $2^{14}$ | 14.75 | 4.27 | 3.29 | **3.04** |
| $2^{15}$ | 16.61 | 4.47 | 3.68 | **3.61** |
| $2^{16}$ | 19.36 | 5.19 | 4.07 | **4.11** |
| $2^{17}$ | 24.37 | 7.88 | 4.57 | **4.39** |
| $2^{18}$ | 33.81 | 8.41 | 5.53 | **5.02** |
| $2^{19}$ | 33.96 | 8.85 | 6.17 | **5.90** |
| $2^{20}$ | 38.28 | 9.37 | 6.94 | **6.77** |
| $2^{21}$ | 43.11 | 13.04 | 7.59 | **7.38** |
| $2^{22}$ | 48.77 | 13.72 | 8.62 | **8.13** |
| $2^{23}$ | 56.38 | 14.47 | 9.53 | **9.03** |
| $2^{24}$ | 65.83 | 15.37 | 10.30 | **10.04** |
| $2^{25}$ | 81.48 | 20.18 | 11.29 | **11.07** |
| $2^{26}$ |  | 21.07 | **12.30** |  |
...
| :--- |  :---: | :---: | :---: |
| $2^{10}$ | 13749.73 | **4259.05** |  |
| $2^{11}$ | 6501.88 | **2984.25** |  |
| $2^{12}$ | **3318.85** | 4515.08 | 20643.84 |
| $2^{13}$ | **2983.10** |  | 31498.24 |
| $2^{14}$ | 5902.74 | **4804.90** | 13639.68 |
| $2^{15}$ | 5772.58 | **4973.78** | 15032.32 |
| $2^{16}$ | **5064.08** | 5437.41 | 16302.08 |
| $2^{17}$ | **4149.23** | 4900.04 | 22446.08 |
| $2^{18}$ | **5302.63** |  | 26583.04 |
| $2^{19}$ | **5458.54** | 7904.41 | 32399.36 |
| $2^{20}$ | **5738.74** | 9862.76 | 36659.20 |
| $2^{21}$ | **6368.66** | 11800.50 | 43950.08 |
| $2^{22}$ | **6878.30** |  | 48128.00 |
| $2^{23}$ | **8357.75** | 14995.49 | 64552.96 |
| $2^{24}$ | **8836.04** | 17328.81 | 65904.64 |
| $2^{25}$ | **9651.10** | 33813.70 | 84336.64 |
| $2^{26}$ | **10353.66** | 39976.57 | 81551.36 |
...
| N | olabs_umap_sharded-4096 | olabs_rostl_sharded-4096 | Signal_Sharded-4096 |
| :--- |  :---: | :---: | :---: |
| $2^{10}$ | 297896.72 | **961716.16** |  |
| $2^{11}$ | 629971.25 | **1372539.70** |  |
| $2^{12}$ | **1234160.95** | 907182.62 | 198452.91 |
| $2^{13}$ | **1373069.90** |  | 130044.45 |
| $2^{14}$ | 693914.76 | **852463.66** | 300086.56 |
| $2^{15}$ | 709560.87 | **823518.68** | 272384.73 |
| $2^{16}$ | **808834.46** | 753299.24 | 251091.91 |
| $2^{17}$ | **987172.01** | 835911.81 | 182582.01 |
| $2^{18}$ | **772447.25** |  | 154155.17 |
| $2^{19}$ | **750383.43** | 518191.72 | 126428.27 |
| $2^{20}$ | **713745.44** | 415299.54 | 111731.96 |
| $2^{21}$ | **643148.98** | 347103.84 | 93213.90 |
| $2^{22}$ | **595496.22** |  | 85082.81 |
| $2^{23}$ | **490083.88** | 273148.87 | 63448.79 |
| $2^{24}$ | **463556.08** | 236369.42 | 62168.17 |
| $2^{25}$ | **424407.51** | 121134.34 | 48556.98 |

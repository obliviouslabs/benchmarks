...
class OMapDataFixture16 : public benchmark::Fixture
{
public:
    size_t n;
...
BENCHMARK_DEFINE_F(OMapDataFixture16, OMap)
...
BENCHMARK_REGISTER_F(OMapDataFixture16, OMap)->Apply(CustomizedArgsN)->MeasureProcessCPUTime()->UseRealTime();